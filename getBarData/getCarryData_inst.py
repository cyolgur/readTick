...
def writeContract(contractList, dateList, inst):
    ...
    contract_log.to_csv(os.path.join(PATH_CONTRACT, '{}.csv'.format(inst)))
    return
...
def get1minBarData(start, end, inst):
    ...
    writeContract(tmp_main_contract, realDateList, inst)
    return
...
if __name__ == '__main__':
    ...
    for symbol in NEWSYMBOLS:
        get1minBarData('20100101', '20221118', symbol)
